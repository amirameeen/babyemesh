...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	?>
	<div id="login">
		<h1 style="visibility: hidden;"><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>" tabindex="-1"><?php echo $login_header_text; ?></a></h1>
	<?php
